  ...
  return (
    <Layout>
      ...
      <section className="relative pt-32 pb-20 bg-background overflow-hidden">
        {/* Glow */}
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-secondary/15 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="section-container relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/10 text-secondary border border-secondary/30 mb-8">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Everything you need to know about working with us. Can't find your
              answer? Reach out to our team directly.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                className="border border-border rounded-xl overflow-hidden hover:border-secondary/30 transition-colors duration-300"
              >
                <button
                  onClick={() =>
